...
namespace _2048 {
    /// <summary>
    /// Adapted from http://tech.pro/tutorial/656/csharp-creating-rounded-rectangles-using-a-graphics-path
    /// Credit to Michael Kuehl
    /// </summary>
    public abstract class RoundedRectangle {
        ...
        public static GraphicsPath Create(int x, int y, int width, int height,
            int radius = 5, RectangleCorners corners = RectangleCorners.All) {
            int xw = x + width;
            int yh = y + height;
            int xwr = xw - radius;
            int yhr = yh - radius;
